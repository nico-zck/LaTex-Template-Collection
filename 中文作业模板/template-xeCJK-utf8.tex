...
%定义mac字体，默认所有字体均可由mac系统自动下载
%其他字体可以参考自带app字体册
\setCJKmainfont[BoldFont={STHeitiSC-Light}, ItalicFont={STKaitiSC-Regular}]{STSongti-SC-Regular}
\setCJKsansfont{STHeitiSC-Light}
...
\section*{模板介绍}
\begin{spacing}{1.0}
{\kaiti 这个 \LaTeX 模板是UTF-8编码的，使用xeCJK宏包，中英文混排更美观，但编译速度稍慢。{\color{red} 注意：} 该模板只能用 XeLaTex 编译。这个模板是UTF-8编码的，使用xeCJK宏包，中英文混排更美观，但编译速度稍慢。注意：该模板只能用xelatex编译。}
\end{spacing}
